...
class NotificationService {
  ...
  Future<bool> scheduleNotification({
    ...
    try {
      ...
      log(
        'NotificationService: Scheduled notification - ID: $id, Time: $scheduledTime',
      );
      return true;
    } catch (e) {
  ...
  Future<bool> updateNotification({
    ...
    try {
      ...
      if (!cancelled) {
        log(
          'NotificationService: Failed to cancel existing notification for update',
        );
        return false;
      }
      ...
      if (scheduled) {
        log(
          'NotificationService: Updated notification - ID: $id, New time: $newTime',
        );
      }
