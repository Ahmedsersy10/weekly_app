...
class SupabaseDataService {
  ...
  static Future<void> saveCategory(TaskCategoryModel category) async {
    try {
      ...
      final categoryData = {
        ...
        'icon_code_point': categoryWithUserId.icon.codePoint,
        'icon_font_family': categoryWithUserId.icon.fontFamily,
  ...
  static Future<void> syncLocalDataToSupabase({
    ...
    try {
      ...
      final customCategories = localCategories
  ...
  static Map<String, String> _encodeReminderTimes(Map<int, TimeOfDay> reminderTimes) {
    return reminderTimes.map((day, time) => 
        MapEntry(day.toString(), '${time.hour}:${time.minute}'));
  }
