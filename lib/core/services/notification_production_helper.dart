...
class NotificationProductionHelper {
    ...
    try {
      ...
      if (Platform.isAndroid) {
        ...
        if (androidImplementation != null) {
          ...
          log('NotificationProductionHelper: Android permissions - Notifications: $notificationGranted, ExactAlarms: $exactAlarmGranted');
        }
      }
  ...
  static Future<Map<String, dynamic>> getProductionStatusReport() async {
    ...
    try {
      ...
      report['pending_notifications'] = pendingNotifications.map((n) => {
        'id': n.id,
        'title': n.title,
        'body': n.body,
      }).toList();
